...
public class Reception extends JFrame {
	...
	public Reception() {
		...
		add(l1);
		// adds button named New Customer Form
		...
		// adds button named Room
		JButton btnNewButton = new JButton("Room");
		btnNewButton.addActionListener(new ActionListener() {
			// Use for taking action when the button is clicked
		...
		// adds button named All Employee Info
		JButton btnNewButton_2 = new JButton("All Employee Info");
		btnNewButton_2.addActionListener(new ActionListener() {
			// Use for taking ction when the button is clicked
			public void actionPerformed(ActionEvent e) {
				try {
